    ...
    <svg className="closeButton" width="48px" height="48px" viewBox="0 0 48 48" version="1.1" onClick={this.props.onClick}>
        ...
        <g id="closeIcon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Group-15">
                ...
                <path d="M16.3809524,16.3809524 L32,32" id="Line" stroke="#FFFFFF" stroke-width="5" stroke-linecap="square"></path>
                <path d="M16.3809524,16.3809524 L32,32" id="Line" stroke="#FFFFFF" stroke-width="5" stroke-linecap="square" transform="translate(24.000000, 24.000000) scale(-1, 1) translate(-24.000000, -24.000000) "></path>
            </g>
        </g>
    </svg>
);
