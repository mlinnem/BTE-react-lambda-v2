...
render() {
  ...
  var percentWinString = (this.props.winPercentage * 100).toFixed(0) + "%";
  var widthAsViewWidth = (this.props.winPercentage * (90)).toFixed(0) + "vw"; //Leave room for margins and other bits.
  var agreeDisagree;
